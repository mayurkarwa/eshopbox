...
<rss version="2.0"
	...
	<?php
	/** This action is documented in eshop-includes/feed-rss2.php */
	do_action( 'rss2_ns' );
	?>
...
<channel>
	...
	<?php /** This filter is documented in eshop-includes/feed-rss2.php */ ?>
	...
	<item>
		<title><?php
			if ( !is_singular() ) {
				...
				/** This filter is documented in eshop-includes/feed.php */
