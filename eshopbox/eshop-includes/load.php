 ...
 * eshop-admin/setup-config.php. We must globalize $wpdb to ensure that it is
...
function wp_not_installed() {
	if ( is_multisite() ) {
		...
		$link = wp_guess_url() . '/eshop-admin/install.php';
...
/**
 * Whether the current request is for a blog admin screen /eshop-admin/
 *
...
/**
 * Whether the current request is for a network admin screen /eshop-admin/network/
 *
...
/**
 * Whether the current request is for a user admin screen /eshop-admin/user/
 *
 * Does not inform on whether the user is an admin! Use capability checks to
 * tell if the user should be accessing a section or not.
 *
