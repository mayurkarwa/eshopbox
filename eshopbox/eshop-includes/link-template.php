...
function get_search_comments_feed_link($search_query = '', $feed = '') {
	...
	/** This filter is documented in eshop-includes/link-template.php */
...
function get_home_url( $blog_id = null, $path = '', $scheme = null ) {
	...
	if ( ! in_array( $scheme, array( 'http', 'https', 'relative' ) ) ) {
		if ( is_ssl() && ! is_admin() && 'eshop-login.php' !== $GLOBALS['pagenow'] )
			$scheme = 'https';
		else
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url($blog_id, 'eshop-admin/', $scheme);
...
function includes_url( $path = '', $scheme = null ) {
	 ...
	 * @param string $path Path relative to the URL to the eshop-includes directory. Blank string
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url('eshop-admin/network/', $scheme);
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url('eshop-admin/user/', $scheme);
