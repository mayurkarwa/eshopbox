...
function get_term_by($field, $value, $taxonomy, $output = OBJECT, $filter = 'raw') {
	...
	/** This filter is documented in eshop-includes/taxonomy.php */
...
function get_terms($taxonomies, $args = '') {
	...
	/** This filter is documented in eshop-includes/taxonomy */
...
function wp_insert_term( $term, $taxonomy, $args = array() ) {
	...
	if ( empty($slug) ) {
		...
		/** This action is documented in eshop-includes/taxonomy.php */
