...
class WP_Admin_Bar {
	...
	final protected function _render_container( $node ) {
		...
		?><div id="<?php echo esc_attr( 'eshop-admin-bar-' . $node->id ); ?>" class="ab-group-container"><?php
	...
	final protected function _render_group( $node ) {
		...
		?><ul id="<?php echo esc_attr( 'eshop-admin-bar-' . $node->id ); ?>"<?php echo $class; ?>><?php
	...
	final protected function _render_item( $node ) {
		...
		<li id="<?php echo esc_attr( 'eshop-admin-bar-' . $node->id ); ?>"<?php echo $menuclass; ?>><?php
			if ( $has_link ):
