 ...
 * at eshop-admin/network/settings.php. The check is only run on
 * self-registrations; user creation at eshop-admin/network/users.php
 * bypasses this check.
 *
 * @since MU
 *
...
Username: USERNAME
Password: PASSWORD
Log in here: BLOG_URLeshop-login.php
 ...
 * which is defined in eshop-includes/functions.php in
 * get_allowed_mime_types(). This function is used to filter
 * that list against the filetype whitelist provided by Multisite
 * Super Admins at eshop-admin/network/settings.php.
 *
 * @since MU
 *
 * @param array $mimes
...
function wp_maybe_update_network_user_counts() {
	...
	/** This filter is documented in eshop-includes/ms-functions.php */
