 ...
 * 2. Not all core admin classes are filterable, notably: eshop-admin, wp-core-ui, and no-js cannot be removed.
 *
 * @since 2.3.0
 *
 ...
 */
?>
<body class="eshop-admin wp-core-ui no-js <?php echo apply_filters( 'admin_body_class', '' ) . " $admin_body_class"; ?>">
<script type="text/javascript">
...
<?php require(ABSPATH . 'eshop-admin/menu-header.php'); ?>
<div id="wpcontent">
...
if ( $parent_file == 'options-general.php' )
	require(ABSPATH . 'eshop-admin/options-head.php');
