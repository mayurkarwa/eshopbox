...
/** Load wpdb */
require_once( ABSPATH . 'eshop-includes/wp-db.php' );
...
if ( is_blog_installed() ) {
	display_header();
	die( '<h1>' . __( 'Already Installed' ) . '</h1><p>' . __( 'You appear to have already installed WordPress. To reinstall please clear your old database tables first.' ) . '</p><p class="step"><a href="../eshop-login.php" class="button button-large">' . __( 'Log In' ) . '</a></p></body></html>' );
}
...
<p class="step"><a href="../eshop-login.php" class="button button-large"><?php _e( 'Log In' ); ?></a></p>
