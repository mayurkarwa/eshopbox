...
function wp_handle_sideload( &$file, $overrides = false, $time = null ) {
	...
	/** This filter is documented in eshop-admin/includes/file.php */
...
function unzip_file($file, $to) {
	...
	/** This filter is documented in eshop-admin/admin.php */
...
function _unzip_file_pclzip($file, $to, $needed_dirs = array()) {
	...
	require_once(ABSPATH . 'eshop-admin/includes/class-pclzip.php');
...
function WP_Filesystem( $args = false, $context = false ) {
	...
	require_once(ABSPATH . 'eshop-admin/includes/class-wp-filesystem-base.php');
	...
	if ( ! class_exists("WP_Filesystem_$method") ) {
		 ...
		 */
		$abstraction_file = apply_filters( 'filesystem_method_file', ABSPATH . 'eshop-admin/includes/class-wp-filesystem-' . $method . '.php', $method );
