...
require ABSPATH . 'eshop-admin/includes/class-wp-upgrader-skins.php';
...
class WP_Upgrader {
	...
	function run($options) {
		...
		if ( ! $is_multi ) {
			...
			/** This action is documented in eshop-admin/includes/class-wp-upgrader.php */
...
/**
 * Core Upgrader class for WordPress. It allows for WordPress to upgrade itself in combination with the eshop-admin/includes/update-core.php file
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 2.8.0
...
class Core_Upgrader extends WP_Upgrader {
	...
	function upgrade( $current, $args = array() ) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/wordpress/eshop-admin/includes/update-core.php', $wp_dir . 'eshop-admin/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
			return new WP_Error( 'copy_failed_for_update_core_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), 'eshop-admin/includes/update-core.php' );
		}
		$wp_filesystem->chmod($wp_dir . 'eshop-admin/includes/update-core.php', FS_CHMOD_FILE);

		require_once( ABSPATH . 'eshop-admin/includes/update-core.php' );
