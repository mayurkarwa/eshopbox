...
class WP_Filesystem_Base {
	...
	function abspath() {
		...
		// Perhaps the FTP folder is rooted at the WordPress install, Check for eshop-includes folder in root, Could have some false positives, but rare.
		if ( ! $folder && $this->is_dir('/eshop-includes') )
			$folder = '/';
		return $folder;
	}
