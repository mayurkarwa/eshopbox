...
class Walker_Category_Checklist extends Walker {
	...
	function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
		...
		/** This filter is documented in eshop-includes/category-template.php */
...
function get_inline_data($post) {
	...
	/** This filter is documented in eshop-admin/edit-tag-form.php */
	echo '
...
<?php
/** This action is documented in eshop-admin/admin-header.php */
...
<?php /** This filter is documented in eshop-admin/admin-header.php */ ?>
<body<?php if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="eshop-admin wp-core-ui no-js iframe <?php echo apply_filters( 'admin_body_class', '' ) . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
//<![CDATA[
(function(){
...
function iframe_footer() {
	...
	<div class="hidden">
<?php
	/** This action is documented in eshop-admin/admin-footer.php */
...
<![endif]-->
<!--[if !(IE 8) ]><!-->
<?php /** This action is documented in eshop-admin/includes/template.php */ ?>
...
function convert_to_screen( $hook_name ) {
	if ( ! class_exists( 'WP_Screen' ) ) {
		_doing_it_wrong( 'convert_to_screen(), add_meta_box()', __( "Likely direct inclusion of eshop-admin/includes/template.php in order to use add_meta_box(). This is very wrong. Hook the add_meta_box() call into the add_meta_boxes action instead." ), '3.3' );
