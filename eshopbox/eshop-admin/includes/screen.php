...
final class WP_Screen {
	...
	function render_per_page_options() {
		...
		if ( 'edit_comments_per_page' == $option ) {
			...
			/** This filter is documented in eshop-admin/includes/class-wp-comments-list-table.php */
			$per_page = apply_filters( 'comments_per_page', $per_page, $comment_status );
		} elseif ( 'categories_per_page' == $option ) {
			/** This filter is documented in eshop-admin/includes/class-wp-terms-list-table.php */
			$per_page = apply_filters( 'edit_categories_per_page', $per_page );
		} else {
			/** This filter is documented in eshop-admin/includes/class-wp-list-table.php */
			$per_page = apply_filters( $option, $per_page );
		}

		// Back compat
		if ( isset( $this->post_type ) ) {
			/** This filter is documented in eshop-admin/includes/class-wp-posts-list-table.php */
