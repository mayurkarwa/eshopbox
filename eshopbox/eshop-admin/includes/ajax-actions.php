...
function wp_ajax_imgedit_preview() {
	...
	include_once( ABSPATH . 'eshop-admin/includes/image-edit.php' );
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in eshop-admin/user-new.php */
...
function wp_ajax_dashboard_widgets() {
	require_once ABSPATH . 'eshop-admin/includes/dashboard.php';
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . 'eshop-admin/includes/nav-menu.php';
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in eshop-admin/widgets.php */
...
function wp_ajax_save_attachment_compat() {
	...
	/** This filter is documented in eshop-admin/includes/media.php */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . 'eshop-admin/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in eshop-admin/includes/class-wp-theme-install-list-table.php */
