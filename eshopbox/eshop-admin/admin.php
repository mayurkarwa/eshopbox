...
if ( get_option('db_upgraded') ) {
	 ...
	 *
	 * In single site, the user would be redirected to eshop-admin/upgrade.php.
	 ...
	 */
		...
		if ( $c <= 50 || ( $c > 50 && mt_rand( 0, (int)( $c / 50 ) ) == 1 ) ) {
			...
			/** This action is documented in eshop-admin/network/upgrade.php */
...
require_once(ABSPATH . 'eshop-admin/includes/admin.php');
...
if ( WP_NETWORK_ADMIN )
	require(ABSPATH . 'eshop-admin/network/menu.php');
elseif ( WP_USER_ADMIN )
	require(ABSPATH . 'eshop-admin/user/menu.php');
else
	require(ABSPATH . 'eshop-admin/menu.php');
...
if ( isset($plugin_page) ) {
	if ( $page_hook ) {
		...
		if (! isset($_GET['noheader']))
			require_once(ABSPATH . 'eshop-admin/admin-header.php');
