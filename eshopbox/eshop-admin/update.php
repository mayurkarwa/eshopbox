...
include_once ABSPATH . 'eshop-admin/includes/class-wp-upgrader.php';
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		include_once ABSPATH . 'eshop-admin/includes/plugin-install.php'; //for plugins_api..
		...
		include_once ABSPATH . 'eshop-admin/includes/theme-install.php'; //for themes_api..
		 ...
		 * provided in the request for eshop-admin/update.php. Can be used to
