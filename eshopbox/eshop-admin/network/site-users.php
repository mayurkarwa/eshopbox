...
require( ABSPATH . 'eshop-admin/admin-header.php' ); ?>
...
/** This filter is documented in eshop-admin/network/site-users.php */
...
<?php
require( ABSPATH . 'eshop-admin/admin-footer.php' );
